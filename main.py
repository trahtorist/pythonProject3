    ...
    while True:
        ...
        if oldest_stream_data_from_stream_buffer is False:
            ...
            if len(unicorn_fied_stream_data) > 4:
                prices_futures = {"SPOT": {unicorn_fied_stream_data["symbol"]: [unicorn_fied_stream_data["best_bid_price"],
                                                                                unicorn_fied_stream_data["best_ask_price"]]}}
                print(prices_futures["SPOT"])
    ...
    while True:
        ...
        if oldest_stream_data_from_stream_buffer is False:
            ...
            if len(unicorn_fied_stream_data) > 4:
                ...
                prices_futures = {"FUT":{unicorn_fied_stream_data["symbol"]: [unicorn_fied_stream_data["best_bid_price"],
                                  unicorn_fied_stream_data["best_ask_price"]]}}
...
markets = ["ethusdt", "btcusdt", "bchusdt"]
channels = ['bookTicker']
